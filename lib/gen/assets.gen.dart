...
class $AssetsBrandingGen {
  ...
  /// File path: assets/branding/app_icon.svg
  SvgGenImage get appIcon => const SvgGenImage('assets/branding/app_icon.svg');
...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/socials.svg
  SvgGenImage get socials => const SvgGenImage('assets/icons/socials.svg');

  /// List of all assets
  List<dynamic> get values => [arrowRight, home, library, settings, socials];
}
